                    ...
                    <div class="dashboard-box table-opp-color-box">
                        ...
                        <form action="{{ route('wisata.add_visitor', $wisata->id) }}" method="POST">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-4">
                                    <div class="col-sm-10">
                                        <input type="number" class="form-control" name="visitor_count" id="visitor_count"
                    ...
                    <div class="dashboard-box table-opp-color-box">
                        <ul>
                            @foreach ($wisata->kunjungan_harian as $visit)
                                <li>{{ \Carbon\Carbon::parse($visit->tanggal_kunjungan)->translatedFormat('d F Y') }}: {{ $visit->jumlah_kunjungan }} visitors</li>
                            @endforeach
                        </ul>
                    </div>
                </div>
