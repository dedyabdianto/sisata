                        ...
                        <tbody>
                            <tr>
                                ...
                                <td><span class="list-img"><img
                                            src="{{ asset('pariwisata/admin/assets/images/comment.jpg') }}"
                                            alt=""></span>
                                </td>
                            ...
                            <tr>
                                ...
                                <td><span class="list-img"><img
                                            src="{{ asset('pariwisata/admin/assets/images/comment2.jpg') }}"
                                            alt=""></span>
                                </td>
                                <td><span class="list-enq-name">John Doe</span>
                                </td>
                            ...
                            <tr>
                                ...
                                <td><span class="list-img"><img
                                            src="{{ asset('pariwisata/admin/assets/images/comment3.jpg') }}"
                                            alt=""></span>
                                </td>
                                <td><span class="list-enq-name">John Doe</span>
                                </td>
                            ...
                            <tr>
                                ...
                                <td><span class="list-img"><img
                                            src="{{ asset('pariwisata/admin/assets/images/comment4.jpg') }}"
                                            alt=""></span>
                                </td>
                                <td><span class="list-enq-name">John Doe</span>
                                </td>
                            ...
                            <tr>
                                ...
                                <td><span class="list-img"><img
                                            src="{{ asset('pariwisata/admin/assets/images/comment5.jpg') }}"
                                            alt=""></span>
                                </td>
                                <td><span class="list-enq-name">John Doe</span>
                                </td>
