            ...
            <div class="dashboard-navigation">
                ...
                <div id="navigation" class="navigation-container">
                    <ul>
                        ...
                        <li class="active-menu"><a href="comment"><i class="fas fa-comments"></i>Comments</a></li>
                            ...
                            <ol>
                                <li>
                                   <figure class="comment-thumb">
                                      <img src="{{ asset ('pariwisata/admin/assets/images/testi-img1-150x150.jpg') }}" alt="">
                                   </figure>
                                ...
                                <ol>
                                    <li>
                                       <figure class="comment-thumb">
                                          <img src="{{ asset ('pariwisata/admin/assets/images/testi-img2-150x150.jpg') }}" alt="">
                                       </figure>
                                       <div class="comment-content">
                                          <div class="comment-header">
                                             <h4 class="author-name">Tom Sawyer</h4>
                   ...
                   <div class="comment-area">
                        <div class="comment-area-inner">
                            <ol>
                                <li>
                                   <figure class="comment-thumb">
                                      <img src="{{ asset ('pariwisata/admin/assets/images/testi-img3-150x150.jpg') }}" alt="">
                                   </figure>
                                   <div class="comment-content">
                                        <div class="comment-header">
                                            <h4 class="author-name">Tom Sawyer</h4>
