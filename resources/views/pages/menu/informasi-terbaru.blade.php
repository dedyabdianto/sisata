...
<html lang="en">
   <head>
      ...
      <!-- light box css -->
      <link rel="stylesheet" type="text/css" href="{{ asset ('pariwisata/assets/vendors/lightbox/dist/css/lightbox.min.css') }}">      <!-- slick slider css -->
               ...
               <div class="inner-baner-container" style="background-image: url({{ asset ('pariwisata/assets/images/inner-banner.jpg') }});">
                  <div class="container">
                     <div class="inner-banner-content">
                        <h1 class="inner-title">Wish List</h1>
                     </div>
                  </div>
               </div>
                     ...
                     <div class="row">
                        <div class="col-lg-4 col-md-6">
                           <div class="package-wrap">
                              <figure class="feature-image">
                                 <a href="#">
                                    <img src="{{ asset ('pariwisata/assets/images/img5.jpg') }}" alt="">
                                 </a>
                              </figure>
                        ...
                        <div class="col-lg-4 col-md-6">
                           <div class="package-wrap">
                              <figure class="feature-image">
                                 <a href="#">
                                    <img src="{{ asset ('pariwisata/assets/images/img6.jpg') }}" alt="">
                                 </a>
                              </figure>
                              <div class="package-price">
                                 <h6>
                        ...
                        <div class="col-lg-4 col-md-6">
                           <div class="package-wrap">
                              <figure class="feature-image">
                                 <a href="#">
                                    <img src="{{ asset ('pariwisata/assets/images/img7.jpg') }}" alt="">
                                 </a>
                              </figure>
                              <div class="package-price">
                                 <h6>
