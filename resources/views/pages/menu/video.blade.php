...
<html lang="en">
   <head>
      ...
      <!-- favicon -->
      <link rel="icon" type="image/png" href="{{ asset ('pariwisata/assets/images/logo-papsel2.png') }}">
      <!-- Bootstrap CSS -->
      <link rel="stylesheet" href="{{ asset ('pariwisata/assets/vendors/bootstrap/css/bootstrap.min.css') }}" media="all">
      <!-- Fonts Awesome CSS -->
      <link rel="stylesheet" type="text/css" href="{{ asset ('pariwisata/assets/vendors/fontawesome/css/all.min.css') }}">
      <!-- jquery-ui css -->
      <link rel="stylesheet" type="text/css" href="{{ asset ('pariwisata/assets/vendors/jquery-ui/jquery-ui.min.css') }}">
      <!-- modal video css -->
      <link rel="stylesheet" type="text/css" href="{{ asset ('pariwisata/assets/vendors/modal-video/modal-video.min.css') }}">
      <!-- light box css -->
      <link rel="stylesheet" type="text/css" href="{{ asset ('pariwisata/assets/vendors/lightbox/dist/css/lightbox.min.css') }}">
      <!-- slick slider css -->
      <link rel="stylesheet" type="text/css" href="{{ asset ('pariwisata/assets/vendors/slick/slick.css') }}">
      <link rel="stylesheet" type="text/css" href="{{ asset ('pariwisata/assets/vendors/slick/slick-theme.css') }}">
      <!-- google fonts -->
      ...
      <div id="page" class="full-page">
                     ...
                     <nav id="navigation" class="navigation">
                        <ul>
                           ...
                           <li class="menu-item-has-children">
                              <a href="#">Informasi</a>
                              <ul>
                                 <li><a href="blog-single.html">Berita</a></li>
                                 <li><a href="blog-archive-both.html">Events</a></li>
                                 <li><a href="blog-archive.html">Pengumuman</a></li>
                                 <li><a href="package-detail.html">Desa Wisata</a></li>
                                 <li><a href="tour-cart.html">Daya Tarik Wisata</a></li>
                                 <li><a href="booking.html">Industri Pariwisata</a></li>
                           ...
                           <li class="menu-item-has-children">
                              ...
                              <ul>
                                 ...
                                 <li><a href="tour-guide.html">Struktur Organisasi</a></li>
         ...
         <main id="content" class="site-main">
            ...
            <section class="inner-banner-wrap">
               <div class="inner-baner-container" style="background-image: url({{ asset ('pariwisata/assets/images/inner-banner.jpg') }});">
                  <div class="container">
                     ...
                     <div class="gallery-inner-wrap gallery-container grid">
                        <div class="single-gallery grid-item">
                           <figure class="gallery-img">
                              <img src="{{ asset ('pariwisata/assets/images/gallery-1.jpg') }}" alt="">
                              <div class="gallery-title">
                                 <h3>
                                    <a href="{{ asset ('pariwisata/assets/images/gallery-1.jpg') }}" data-lightbox="lightbox-set">
                                       Santorini Island
                                    </a>
                                 </h3>
                              </div>
                        ...
                        <div class="single-gallery grid-item">
                           <figure class="gallery-img">
                              <img src="{{ asset ('pariwisata/assets/images/gallery-2.jpg') }}" alt="">
                              <div class="gallery-title">
                                 <h3>
                                    <a href="{{ asset ('pariwisata/assets/images/gallery-2.jpg') }}" data-lightbox="lightbox-set">
                                       Malaysia Beach
                                    </a>
                                 </h3>
                              </div>
                        ...
                        <div class="single-gallery grid-item">
                           <figure class="gallery-img">
                              <img src="{{ asset ('pariwisata/assets/images/gallery-3.jpg') }}" alt="">
                              <div class="gallery-title">
                                 <h3>
                                    <a href="{{ asset ('pariwisata/assets/images/gallery-3.jpg') }}" data-lightbox="lightbox-set">
                                       Tibet Mountain
                                    </a>
                                 </h3>
                              </div>
                        ...
                        <div class="single-gallery grid-item">
                           <figure class="gallery-img">
                              <img src="{{ asset ('pariwisata/assets/images/gallery-4.jpg') }}" alt="">
                              <div class="gallery-title">
                                 <h3>
                                    <a href="{{ asset ('pariwisata/assets/images/gallery-4.jpg') }}" data-lightbox="lightbox-set">
                                       Arizona Desert
                                    </a>
                                 </h3>
                              </div>
                        ...
                        <div class="single-gallery grid-item">
                           <figure class="gallery-img">
                              <img src="{{ asset ('pariwisata/assets/images/gallery-5.jpg') }}" alt="">
                              <div class="gallery-title">
                                 <h3>
                                    <a href="{{ asset ('pariwisata/assets/images/gallery-5.jpg') }}" data-lightbox="lightbox-set">
                                       Burj Khalifa (Dubai)
                                    </a>
                                 </h3>
                              </div>
                        ...
                        <div class="single-gallery grid-item">
                           <figure class="gallery-img">
                              <img src="{{ asset ('pariwisata/assets/images/gallery-6.jpg') }}" alt="">
                              <div class="gallery-title">
                                 <h3>
                                    <a href="{{ asset ('pariwisata/assets/images/gallery-6.jpg') }}" data-lightbox="lightbox-set">
                                       Oxolotan Island
                                    </a>
                                 </h3>
                              </div>
                        ...
                        <div class="single-gallery grid-item">
                           <figure class="gallery-img">
                              <img src="{{ asset ('pariwisata/assets/images/gallery-7.jpg') }}" alt="">
                              <div class="gallery-title">
                                 <h3>
                                    <a href="{{ asset ('pariwisata/assets/images/gallery-7.jpg') }}" data-lightbox="lightbox-set">
                                       Narita Airport
                                    </a>
                                 </h3>
                              </div>
                        ...
                        <div class="single-gallery grid-item">
                           <figure class="gallery-img">
                              <img src="{{ asset ('pariwisata/assets/images/gallery-8.jpg') }}" alt="">
                              <div class="gallery-title">
                                 <h3>
                                    <a href="{{ asset ('pariwisata/assets/images/gallery-8.jpg') }}" data-lightbox="lightbox-set">
                                       Thailand Temple
                                    </a>
                                 </h3>
                              </div>
                  ...
                  <div class="row">
                     <div class="col-lg-3 col-md-6">
                        <aside class="widget widget_text">
                           ...
                           <div class="award-img">
                              <a href="#"><img src="{{ asset ('pariwisata/assets/images/logo6.png') }}" alt=""></a>
                              <a href="#"><img src="{{ asset ('pariwisata/assets/images/logo2.png') }}" alt=""></a>
                           </div>
                        </aside>
                     </div>
                     <div class="col-lg-3 col-md-6">
                  ...
                  <div class="row align-items-center">
                     ...
                     <div class="col-md-2 text-center">
                        <div class="footer-logo">
                           <a href="#"><img src="{{ asset ('pariwisata/assets/images/travele-logo.png') }}" alt=""></a>
                        </div>
                     </div>
                     <div class="col-md-5">
