...
@section('content')
         <main id="content" class="site-main">
                  ...
                  <div class="row">
                     <div class="col-lg-8">
                        <div class="single-tour-inner">
                           ...
                           <figure class="feature-image">
                              <img src="{{ asset ('pariwisata/assets/images/img27.jpg') }}" alt="">
                                          ...
                                          <ol>
                                             <li>
                                                <figure class="comment-thumb">
                                                   <img src="{{ asset ('pariwisata/assets/images/img20.jpg') }}" alt="">
                                                </figure>
                           ...
                           <div class="single-tour-gallery">
                              ...
                              <div class="single-tour-slider">
                                 <div class="single-tour-item">
                                    <figure class="feature-image">
                                       <img src="{{ asset ('pariwisata/assets/images/img28.jpg') }}" alt="">
                                    </figure>
                                 </div>
                                 <div class="single-tour-item">
                                    <figure class="feature-image">
                                       <img src="{{ asset ('pariwisata/assets/images/img29.jpg') }}" alt="">
                                    </figure>
                                 </div>
                                 <div class="single-tour-item">
                                    <figure class="feature-image">
                                       <img src="{{ asset ('pariwisata/assets/images/img32.jpg') }}" alt="">
                                    </figure>
                                 </div>
                                 <div class="single-tour-item">
                                    <figure class="feature-image">
                                       <img src="{{ asset ('pariwisata/assets/images/img33.jpg') }}" alt="">
                                    </figure>
                                 </div>
                              </div>
                           </div>
                     ...
                     <div class="col-lg-4">
                        <div class="sidebar">
                           ...
                           <div class="travel-package-content text-center" style="background-image: url({{ asset ('pariwisata/assets/images/img11.jpg') }});">
                              <h5>MORE PACKAGES</h5>
            ...
            <section class="subscribe-section" style="background-image: url({{ asset ('pariwisata/assets/images/img16.jpg') }});">
               <div class="container">
                  <div class="row">
                     <div class="col-lg-7">
